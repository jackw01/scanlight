...
Press the **left button** to toggle the light on and off. Press the **right button** to toggle between narrowband RGB and 95CRI white modes. The buttons work even when the light is not connected to a computer. The deult RGB channel brightnesses in this mode can be configured from the GUI, as explained below.
